...
const BentoInner: React.FC<Props> = ({ icon, title, desc }) => {
  return (
    <div className="relative group flex flex-col items-start p-4 rounded-xl w-full h-full bg-white shadow-mg hover:shadow-lg transition-shadow overflow-hidden">
