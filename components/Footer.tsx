...
const Footer = () => {
	...
	return (
		<footer className="text-black px-6 py-10 md:px-32 md:py-16 w-full">
			<div className="flex flex-col md:flex-row justify-between align-center gap-12 md:gap-24">
				<section className="flex-1 flex flex-col gap-1">
					<div className="relative flex items-center gap-3 mb-5">
						<Image src="/logo/default.png" alt="My Health Notion Logo" width={40} height={40} />
						<p className="text-2xl font-bold tracking-tight">My Health Notion</p>
					...
					<form onSubmit={handleEmailSubmit} className="relative w-full max-w-xs mb-6">
						<input
							autoComplete="off"
							id="home-mail"
							name="home-mail"
					...
					<div className="flex gap-4">
						...
						<a href="https://www.youtube.com/@MyHealthNotion" aria-label="YouTube" target="_blank">
							<YoutubeLogoIcon size={28} />
						</a>
						<a href="https://x.com/myhealthnotion" aria-label="X" target="_blank">
							<XLogoIcon size={28} />
						</a>
					</div>
				</section>
