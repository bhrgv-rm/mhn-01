...
const Finale = () => {
	return (
		<div className=" text-center text-black flex flex-col items-center justify-center w-[90vw] rounded-xl md:p-16 p-8 mx-auto border shadow-lg">
			<h1 className="uppercase text-md tracking-tight font-semibold md:mb-8 mb-4">
				Download the App
			</h1>
			<h2 className="font-bold tracking-tighter align-center md:text-7xl text-4xl text-balance">
